...
class OldFactory
{
    ...
    /**
     * @param OldReportableInterface $reportable
     * @return OldReportInterface
     */
    public static function makeReport(OldReportableInterface $reportable): OldReportInterface
    {
     ...
     * @return OldFormatterInterface
     */
    public static function makeFormatter(OldReportInterface $report): OldFormatterInterface
    {
